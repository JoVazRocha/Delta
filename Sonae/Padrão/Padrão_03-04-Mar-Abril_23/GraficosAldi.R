...
# Ler ficheiros
fileNinjas1 <- read_excel("D:\\Brands and Ninjas\\Delta\\Mar-abril23\\CafesAldi.xlsx")
...
fileNinjas <- fileNinjas1 %>%
  rename('DATA' = 'Data de Resposta', "STORE"="Código da loja", "Loja"="Nome da Loja")
...
F1<-ggplot(data = fileNinjas, aes(x = Loja, y = `DeltaQ XL QALIDUS (40 CAPS)`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())

F2<-ggplot(data = fileNinjas, aes(x = Loja, y = `DeltaQ XL QHARACTER (40 CAPS)`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())

F3<-ggplot(data = fileNinjas, aes(x = Loja, y = `DeltaQ XL AQTIVUS (40 CAPS)`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())

F4<-ggplot(data = fileNinjas, aes(x = Loja, y = `DeltaQ XL MYTHIQ (40 CAPS)`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())

F5<-ggplot(data = fileNinjas, aes(x = Loja, y = `DELTA Q deQafeinatus Cx. 10UN`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())

F6<-ggplot(data = fileNinjas, aes(x = Loja, y = `Lote Chávena MQ 250g`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())

F7<-ggplot(data = fileNinjas, aes(x = Loja, y = `CAFFE GRÃO CHAVENA 1KG`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())

F8<-ggplot(data = fileNinjas, aes(x = Loja, y = `Cafés Solúvel 200g`)) +
  geom_bar(stat = "identity", fill = "dark orange") +
  labs(x = "Loja", y = "Presença do produto no Linear") + theme(axis.text.x = element_blank(), panel.background = element_blank())
