...
#Dados todos
Dados <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_06_2023\\OUT_2_DataFusion.xlsx")
Dados_22 <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_06_2023\\OUT_2_DataFusion_2022.xlsx")
...
df_Classic <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_06_2023\\OUT_5_med.xlsx")
df_ClassicRep <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_06_2023\\OUT_5_med_reposto.xlsx")
df_ClassicSemRep <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_06_2023\\OUT_5_med_naoreposto.xlsx")

df_NumProdutos <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_06_2023\\OUT_5_NumProdutos.xlsx")

df_Rotura <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_06_2023\\OUT_5_Rotura.xlsx")
...
#Ordem dos elementos
#1º Elemento: CAFÉ DELTA Q AQTIVUS 10CAP
#Último elemento: PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP


#Nº de Produtos: 14
#produto1 <-  "#ff6504 CAFÉ DELTA Q AQTIVUS 10CAP"  
#produto2 <-  "#662867 CAFÉ DELTA Q MYTHIQ 10CAP"  
#produto3 <-  "#e8e4c9 CAFÉ BELLISSIMO AROMA INTENSO 30CAP" 
#produto4 <-  "#c42d1d CAFÉ GINGA 10CAP"  
#produto5 <-  "#3a2120 CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G"  
#produto6 <-  "#dedec7 CAFÉ DELTA RITUAL MU 220G" 
#produto7 <-  "#dedec7 CAFÉ TORRADO RITUAL DELTA GRÃO  500G" 
...
perc1 <- aggregate(`CAFÉ DELTA Q AQTIVUS 10CAP` ~ DATA,DATAFUSION, mean)
G1<-ggplot(perc1, aes(x = DATA, y = `CAFÉ DELTA Q AQTIVUS 10CAP`)) + 
...
DATAFUSION$fimQalidus<- ifelse(DATAFUSION$`CAFÉ DELTA Q AQTIVUS 10CAP`==0, 0.1, 1)
...
perc2 <- aggregate(`CAFÉ DELTA Q MYTHIQ 10CAP` ~ DATA,DATAFUSION, mean)
G2<-ggplot(perc2, aes(x = DATA, y = `CAFÉ DELTA Q MYTHIQ 10CAP`)) + 
  geom_col(fill="#662867") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimMythiq<- ifelse(DATAFUSION$`CAFÉ DELTA Q MYTHIQ 10CAP` ==0, 0.1, 1)
...
perc5 <- aggregate(`CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G` ~ DATA,DATAFUSION, mean)
G5<-ggplot(perc5, aes(x = DATA, y = `CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) + 
  geom_col(fill="#3a2120") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimChav<- ifelse(DATAFUSION$`CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G` ==0, 0.1, 1)
...
DATAFUSION$fimRit2<- ifelse(DATAFUSION$`CAFÉ DELTA RITUAL MU 220G` ==0, 0.1, 1)
...
perc7 <- aggregate(`CAFÉ TORRADO RITUAL DELTA GRÃO  500G` ~ DATA,DATAFUSION, mean)
G7<-ggplot(perc7, aes(x = DATA, y = `CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) + 
  geom_col(fill="#dedec7") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimRit5<- ifelse(DATAFUSION$`CAFÉ TORRADO RITUAL DELTA GRÃO  500G` ==0, 0.1, 1)
...
perc8 <- aggregate(`CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G` ~ DATA,DATAFUSION, mean)
G8<-ggplot(perc8, aes(x = DATA, y = `CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) + 
  geom_col(fill="#24a01a") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimBrasil<- ifelse(DATAFUSION$`CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G` ==0, 0.1, 1)
...
perc9 <- aggregate(`CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G` ~ DATA,DATAFUSION, mean)
G9<-ggplot(perc9, aes(x = DATA, y = `CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) + 
  geom_col(fill="#b26628") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimAngola<- ifelse(DATAFUSION$`CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G` ==0, 0.1, 1)
...
perc11 <- aggregate(`CAFÉ DELTA SOLÚVEL INTENSO 200GR` ~ DATA,DATAFUSION, mean)
G11<-ggplot(perc11, aes(x = DATA, y = `CAFÉ DELTA SOLÚVEL INTENSO 200GR`)) + 
  geom_col(fill="#564d49") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimIntenso<- ifelse(DATAFUSION$`CAFÉ DELTA SOLÚVEL INTENSO 200GR` ==0, 0.1, 1)
...
perc12 <- aggregate(`PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP` ~ DATA,DATAFUSION, mean)
G12<-ggplot(perc12, aes(x = DATA, y = `PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)) + 
  geom_col(fill="#98584f") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimQali80<- ifelse(DATAFUSION$`PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP` ==0, 0.1, 1)
...
perc13 <- aggregate(`PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP` ~ DATA,DATAFUSION, mean)
G13<-ggplot(perc13, aes(x = DATA, y = `PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)) + 
  geom_col(fill="#6d4c76") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimMythiq80<- ifelse(DATAFUSION$`PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP` ==0, 0.1, 1)
...
perc14 <- aggregate(`PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP` ~ DATA,DATAFUSION, mean)
G14<-ggplot(perc14, aes(x = DATA, y = `PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)) + 
  geom_col(fill="#715a49") + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),limits = c(0, 1)) +
  labs(x = "Data - fim de semana", y = "Proporção de presenças em lojas")+theme(panel.background = element_blank())

DATAFUSION$fimEpic80<- ifelse(DATAFUSION$`PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP` ==0, 0.1, 1)
...
#FreqC1 <- table(PresençaC1$`SINAL CAFÉ DELTA Q AQTIVUS 10CAP`)  #Também não consigo mudar aqui
...
FreqC1 <- table(PresençaC1$`SINAL CAFÉ DELTA Q AQTIVUS 10CAP`)
dfPercC1<-data.frame(prop.table(FreqC1))
...
PresençaC2 <- DATAFUSION %>%
  dplyr::select(`SINAL CAFÉ DELTA Q MYTHIQ 10CAP`)
PresençaC2<-na.omit(PresençaC2)

FreqC2 <- table(PresençaC2$`SINAL CAFÉ DELTA Q MYTHIQ 10CAP`)
...
FreqC5 <- table(PresençaC5$`SINAL CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)
...
PresençaC7 <- DATAFUSION %>%
  dplyr::select(`SINAL CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)
PresençaC7<-na.omit(PresençaC7)

FreqC7 <- table(PresençaC7$`SINAL CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)
...
PresençaC8 <- DATAFUSION %>%
  dplyr::select(`SINAL CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)
PresençaC8<-na.omit(PresençaC8)

FreqC8 <- table(PresençaC8$`SINAL CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)
...
PresençaC9 <- DATAFUSION %>%
  dplyr::select(`SINAL CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)
PresençaC9<-na.omit(PresençaC9)

FreqC9 <- table(PresençaC9$`SINAL CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)
...
PresençaC11 <- DATAFUSION %>%
  dplyr::select(`SINAL CAFÉ DELTA SOLÚVEL INTENSO 200GR`)
PresençaC11<-na.omit(PresençaC11)

FreqC11 <- table(PresençaC11$`SINAL CAFÉ DELTA SOLÚVEL INTENSO 200GR`)
...
PresençaC12 <- DATAFUSION %>%
  dplyr::select(`SINAL PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)
PresençaC12<-na.omit(PresençaC12)

FreqC12 <- table(PresençaC12$`SINAL PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)
...
PresençaC13 <- DATAFUSION %>%
  dplyr::select(`SINAL PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)
PresençaC13<-na.omit(PresençaC13)

FreqC13 <- table(PresençaC13$`SINAL PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)
...
PresençaC14 <- DATAFUSION %>%
  dplyr::select(`SINAL PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)
PresençaC14<-na.omit(PresençaC14)

FreqC14 <- table(PresençaC14$`SINAL PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)
...
C1 <- ggplot(ciclo1, aes(x = `CICLO CAFÉ DELTA Q AQTIVUS 10CAP`)) +
...
ciclo2 <-DATAFUSION %>%
  dplyr::select(`CICLO CAFÉ DELTA Q MYTHIQ 10CAP`)
ciclo2<-na.omit(ciclo2)

C2 <- ggplot(ciclo2, aes(x = `CICLO CAFÉ DELTA Q MYTHIQ 10CAP`)) +
  geom_bar(fill = "#662867", position = "stack") +
  labs(title = "`CICLO ASSEGURADO CAFÉ DELTA Q MYTHIQ 10CAP`",
       x = "Classes",
       y = "Frequência") + theme(panel.background = element_blank())
...
C5 <- ggplot(ciclo5, aes(x = `CICLO CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) +
...
ciclo7 <-DATAFUSION %>%
  dplyr::select(`CICLO CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)
ciclo7<-na.omit(ciclo7)

C7<- ggplot(ciclo7, aes(x = `CICLO CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) +
  geom_bar(fill = "#dedec7", position = "stack") +
  labs(title = "`CICLO ASSEGURADO CAFÉ TORRADO RITUAL DELTA GRÃO  500G`",
       x = "Classes",
       y = "Frequência") + theme(panel.background = element_blank())
...
ciclo8 <-DATAFUSION %>%
  dplyr::select(`CICLO CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)
ciclo8<-na.omit(ciclo8)

C8<- ggplot(ciclo8, aes(x = `CICLO CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) +
  geom_bar(fill = "#24a01a", position = "stack") +
  labs(title = "`CICLO ASSEGURADO CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`",
       x = "Classes",
       y = "Frequência") + theme(panel.background = element_blank())
...
ciclo9 <-DATAFUSION %>%
  dplyr::select(`CICLO CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)
ciclo9<-na.omit(ciclo9)

C9<- ggplot(ciclo9, aes(x = `CICLO CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) +
  geom_bar(fill = "#b26628", position = "stack") +
  labs(title = "`CICLO ASSEGURADO CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`",
       x = "Classes",
       y = "Frequência") + theme(panel.background = element_blank())
...
ciclo11 <-DATAFUSION %>%
  dplyr::select(`CICLO CAFÉ DELTA SOLÚVEL INTENSO 200GR`)
ciclo11<-na.omit(ciclo11)

C11<- ggplot(ciclo11, aes(x = `CICLO CAFÉ DELTA SOLÚVEL INTENSO 200GR`)) +
  geom_bar(fill = "#564d49", position = "stack") +
  labs(title = "`CICLO ASSEGURADO CAFÉ DELTA SOLÚVEL INTENSO 200GR`",
       x = "Classes",
       y = "Frequência") + theme(panel.background = element_blank())
...
C12<- ggplot(ciclo12, aes(x = `CICLO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)) +
...
C13<- ggplot(ciclo13, aes(x = `CICLO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)) +
  geom_bar(fill = "#6d4c76", position = "stack") +
  labs(title = "`CICLO ASSEGURADO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`",
       x = "Classes",
       y = "Frequência") + theme(panel.background = element_blank())
...
C14<- ggplot(ciclo14, aes(x = `CICLO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)) +
...
rot1 <- table(rotura1$`ROTURA CAFÉ DELTA Q AQTIVUS 10CAP`)
...
rotura2 <-DATAFUSION %>%
  dplyr::select(`ROTURA CAFÉ DELTA Q MYTHIQ 10CAP`)
rotura2<-na.omit(rotura2)

rot2 <- table(rotura2$`ROTURA CAFÉ DELTA Q MYTHIQ 10CAP`)
...
rot5 <- table(rotura5$`ROTURA CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)
...
#R51 <- ggplot(rotura5, aes(x = `ROTURA CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) +
#  geom_bar(fill = "#3a2120", position = "stack") +
#  labs(title = "",
#       x = "",
#       y = "") + theme(panel.background = element_blank())
...
rotura7 <-DATAFUSION %>%
  dplyr::select(`ROTURA CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)
rotura7<-na.omit(rotura7)

rot7 <- table(rotura7$`ROTURA CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)
...
#R71 <- ggplot(rotura7, aes(x = `ROTURA CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) +
#  geom_bar(fill = "#dedec7", position = "stack") +
#  labs(title = "",
#       x = "",
#       y = "") + theme(panel.background = element_blank())
...
rotura8 <-DATAFUSION %>%
  dplyr::select(`ROTURA CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)
rotura8<-na.omit(rotura8)

rot8 <- table(rotura8$`ROTURA CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)
...
#R81 <- ggplot(rotura8, aes(x = `ROTURA CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) +
#  geom_bar(fill = "#dedec7", position = "stack") +
#  labs(title = "",
#       x = "",
#       y = "") + theme(panel.background = element_blank())
...
rotura9 <-DATAFUSION %>%
  dplyr::select(`ROTURA CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)
rotura9<-na.omit(rotura9)

rot9 <- table(rotura9$`ROTURA CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)
...
#R91 <- ggplot(rotura9, aes(x = `ROTURA CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) +
#  geom_bar(fill = "#b26628", position = "stack") +
#  labs(title = "",
#       x = "",
#       y = "") + theme(panel.background = element_blank())
...
rotura11 <-DATAFUSION %>%
  dplyr::select(`ROTURA CAFÉ DELTA SOLÚVEL INTENSO 200GR`)
rotura11<-na.omit(rotura11)

rot11 <- table(rotura11$`ROTURA CAFÉ DELTA SOLÚVEL INTENSO 200GR`)
...
rot12 <- table(rotura12$`ROTURA PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)
...
rot13 <- table(rotura13$`ROTURA PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)
...
rot14 <- table(rotura14$`ROTURA PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)
...
Freq1 <- table(adequa1$`ADEQUAÇÃO CAFÉ DELTA Q AQTIVUS 10CAP`)
...
adequa2 <-DATAFUSION %>%
  dplyr::select(`ADEQUAÇÃO CAFÉ DELTA Q MYTHIQ 10CAP`)
adequa2<-na.omit(adequa2)

Freq2 <- table(adequa2$`ADEQUAÇÃO CAFÉ DELTA Q MYTHIQ 10CAP`)
...
Freq5 <- table(adequa5$`ADEQUAÇÃO CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)
...
adequa7 <-DATAFUSION %>%
  dplyr::select(`ADEQUAÇÃO CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)
adequa7<-na.omit(adequa7)

Freq7 <- table(adequa7$`ADEQUAÇÃO CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)
...
adequa8 <-DATAFUSION %>%
  dplyr::select(`ADEQUAÇÃO CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)
adequa8<-na.omit(adequa8)

Freq8 <- table(adequa8$`ADEQUAÇÃO CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)
...
adequa9 <-DATAFUSION %>%
  dplyr::select(`ADEQUAÇÃO CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)
adequa9<-na.omit(adequa9)

Freq9 <- table(adequa9$`ADEQUAÇÃO CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)
...
Freq10 <- table(adequa10$`ADEQUAÇÃO CAFÉ SOLÚVEL DELTA FRASCO 200G`)
...
adequa11 <-DATAFUSION %>%
  dplyr::select(`ADEQUAÇÃO CAFÉ DELTA SOLÚVEL INTENSO 200GR`)
adequa11<-na.omit(adequa11)

Freq11 <- table(adequa11$`ADEQUAÇÃO CAFÉ DELTA SOLÚVEL INTENSO 200GR`)
...
Freq12 <- table(adequa12$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)
...
Freq13 <- table(adequa13$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)
...
Freq14 <- table(adequa14$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)
...
Ci1<-ggplot(ciclo1, aes(x="", y=`CICLO CAFÉ DELTA Q AQTIVUS 10CAP`)) + 
...
Ci2<-ggplot(ciclo2, aes(x="", y=`CICLO CAFÉ DELTA Q MYTHIQ 10CAP`)) + 
  geom_violin(trim=FALSE) +
...
Ci5<-ggplot(ciclo5, aes(x="", y=`CICLO CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) + 
  geom_violin(trim=FALSE) +
...
Ci7<-ggplot(ciclo7, aes(x="", y=`CICLO CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#dedec7", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
Ci8<-ggplot(ciclo8, aes(x="", y=`CICLO CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) + 
  geom_violin(trim=FALSE) +
...
Ci9<-ggplot(ciclo9, aes(x="", y=`CICLO CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) + 
  geom_violin(trim=FALSE) +
...
Ci11<-ggplot(ciclo11, aes(x="", y=`CICLO CAFÉ DELTA SOLÚVEL INTENSO 200GR`)) + 
  geom_violin(trim=FALSE) +
...
Ci12<-ggplot(ciclo12, aes(x="", y=`CICLO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
...
Ci13<-ggplot(ciclo13, aes(x="", y=`CICLO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
...
Ci14<-ggplot(ciclo14, aes(x="", y=`CICLO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
...
SO1<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT CAFÉ DELTA Q AQTIVUS 10CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#ff6504", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO11<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ DELTA Q AQTIVUS 10CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#ff6504", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO2<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT CAFÉ DELTA Q MYTHIQ 10CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#662867", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO21<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ DELTA Q MYTHIQ 10CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#662867", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO31<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ BELLISSIMO AROMA INTENSO 30CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#e8e4c9", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO41<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ GINGA 10CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#c42d1d", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO5<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#3a2120", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO51<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#3a2120", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO7<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#dedec7", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO71<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#dedec7", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO8<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#24a01a", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO81<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#24a01a", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO9<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#b26628", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO91<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#b26628", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO101<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ SOLÚVEL DELTA FRASCO 200G`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#710302", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO11<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT CAFÉ DELTA SOLÚVEL INTENSO 200GR`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#564d49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO111<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT CAFÉ DELTA SOLÚVEL INTENSO 200GR`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#564d49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO12<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#98584f", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO121<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#98584f", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO13<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#6d4c76", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO131<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#6d4c76", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO14<-ggplot(DATAFUSION, aes(x="", y=`SELLOUT PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#715a49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
SO141<-ggplot(DATAFUSION2022, aes(x="", y=`SELLOUT PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)) + 
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="#715a49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
DR1<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura CAFÉ DELTA Q AQTIVUS 10CAP`)) + 
  geom_boxplot(width=0.1, fill="#ff6504", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
...
DR2<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura CAFÉ DELTA Q MYTHIQ 10CAP`)) + 
  geom_boxplot(width=0.1, fill="#662867", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DR5<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) + 
  geom_boxplot(width=0.1, fill="#3a2120", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DR7<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) + 
  geom_boxplot(width=0.1, fill="#dedec7", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DR8<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) + 
  geom_boxplot(width=0.1, fill="#24a01a", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DR9<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) + 
  geom_boxplot(width=0.1, fill="#b26628", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DR11<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura CAFÉ DELTA SOLÚVEL INTENSO 200GR`)) + 
  geom_boxplot(width=0.1, fill="#564d49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")

DR12<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)) + 
  geom_boxplot(width=0.1, fill="#98584f", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")

DR13<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)) + 
  geom_boxplot(width=0.1, fill="#6d4c76", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")

DR14<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)) + 
  geom_boxplot(width=0.1, fill="#715a49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DRL1<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear CAFÉ DELTA Q AQTIVUS 10CAP`)) + 
  geom_boxplot(width=0.1, fill="#ff6504", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DRL2<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear CAFÉ DELTA Q MYTHIQ 10CAP`)) + 
  geom_boxplot(width=0.1, fill="#662867", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DRL5<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear CAFÉ MOÍDO MÁQUINA CHÁVENA DELTA 250G`)) +
  geom_boxplot(width=0.1, fill="#3a2120", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DRL7<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear CAFÉ TORRADO RITUAL DELTA GRÃO  500G`)) + 
...
DRL8<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear CAFÉ DELTA MOAGEM UNIVERSAL BRASIL 220G`)) + 
  geom_boxplot(width=0.1, fill="#24a01a", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DRL9<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear CAFÉ DELTA MOAGEM UNIVERSAL ANGOLA 220G`)) +
  geom_boxplot(width=0.1, fill="#b26628", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
...
DRL11<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear CAFÉ DELTA SOLÚVEL INTENSO 200GR`)) +
  geom_boxplot(width=0.1, fill="#564d49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")

DRL12<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`)) +
  geom_boxplot(width=0.1, fill="#98584f", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")

DRL13<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`)) +
  geom_boxplot(width=0.1, fill="#6d4c76", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")

DRL14<-ggplot(DATAFUSION, aes(x="", y=`Dias_para_Rotura_Linear PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`)) +
  geom_boxplot(width=0.1, fill="#715a49", outlier.size=0.5) +
  coord_flip() +
  theme_classic() +
  labs(x="", y="Dias para a rotura")
