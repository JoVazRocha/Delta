...
DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`/DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP` >1.1] <- "SIM"
DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`/DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP` <=1.1] <- "NÃO"
...
DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`/DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP` >1.1] <- "SIM"
DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`/DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP` <=1.1] <- "NÃO"
...
DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`/DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP` >1.1] <- "SIM"
DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`/DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP` <=1.1] <- "NÃO"
...
DATAFUSION$`CICLO CAFÉ DELTA PORTUGAL MU 220G`[DATAFUSION$`STOCK CAFÉ DELTA PORTUGAL MU 220G`/DATAFUSION$`Preslinear CAFÉ DELTA PORTUGAL MU 220G` >1.1] <- "SIM"
DATAFUSION$`CICLO CAFÉ DELTA PORTUGAL MU 220G`[DATAFUSION$`STOCK CAFÉ DELTA PORTUGAL MU 220G`/DATAFUSION$`Preslinear CAFÉ DELTA PORTUGAL MU 220G` <=1.1] <- "NÃO"
...
DATAFUSION$`CICLO CAFÉ SOLÚVEL DELTA FRASCO 200G`[DATAFUSION$`STOCK CAFÉ SOLÚVEL DELTA FRASCO 200G`/DATAFUSION$`Preslinear CAFÉ SOLÚVEL DELTA FRASCO 200G` >1.1] <- "SIM"
DATAFUSION$`CICLO CAFÉ SOLÚVEL DELTA FRASCO 200G`[DATAFUSION$`STOCK CAFÉ SOLÚVEL DELTA FRASCO 200G`/DATAFUSION$`Preslinear CAFÉ SOLÚVEL DELTA FRASCO 200G` <=1.1] <- "NÃO"
...
DATAFUSION$`ROTURA PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`<=0] <- "ROTURA"
DATAFUSION$`ROTURA PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`[DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`>0] <- "EM STOCK"
...
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`=="SIM"] <- "STOCK SUF."
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`=="NÃO" & DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`+DATAFUSION$`Transito PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`+DATAFUSION$`Esperado PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`>= DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`] <- "STOCK INSUF. C FORN. ADEQUADO"
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`=="NÃO" & DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`+DATAFUSION$`Transito PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`+DATAFUSION$`Esperado PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`< DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND MYTHIQ 72+8 CAP`] <- "STOCK INSUF. C FORN. DESADEQUADO"
...
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`=="SIM"] <- "STOCK SUF."
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`=="NÃO" & DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`+DATAFUSION$`Transito PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`+DATAFUSION$`Esperado PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`>= DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`] <- "STOCK INSUF. C FORN. ADEQUADO"
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`=="NÃO" & DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`+DATAFUSION$`Transito PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`+DATAFUSION$`Esperado PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`< DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND EPIQ 72+8 CAP`] <- "STOCK INSUF. C FORN. DESADEQUADO"
...
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`=="SIM"] <- "STOCK SUF."
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`=="NÃO" & DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`+DATAFUSION$`Transito PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`+DATAFUSION$`Esperado PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`>= DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`] <- "STOCK INSUF. C FORN. ADEQUADO"
DATAFUSION$`ADEQUAÇÃO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`[DATAFUSION$`CICLO PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`=="NÃO" & DATAFUSION$`STOCK PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`+DATAFUSION$`Transito PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`+DATAFUSION$`Esperado PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`< DATAFUSION$`Preslinear PACK CAFÉ DELTA Q GRAND QALIDUS 72+8 CAP`] <- "STOCK INSUF. C FORN. DESADEQUADO"
...
DATAFUSION$`ADEQUAÇÃO CAFÉ DELTA PORTUGAL MU 220G`[DATAFUSION$`CICLO CAFÉ DELTA PORTUGAL MU 220G`=="SIM"] <- "STOCK SUF."
DATAFUSION$`ADEQUAÇÃO CAFÉ DELTA PORTUGAL MU 220G`[DATAFUSION$`CICLO CAFÉ DELTA PORTUGAL MU 220G`=="NÃO" & DATAFUSION$`STOCK CAFÉ DELTA PORTUGAL MU 220G`+DATAFUSION$`Transito CAFÉ DELTA PORTUGAL MU 220G`+DATAFUSION$`Esperado CAFÉ DELTA PORTUGAL MU 220G`>= DATAFUSION$`Preslinear CAFÉ DELTA PORTUGAL MU 220G`] <- "STOCK INSUF. C FORN. ADEQUADO"
DATAFUSION$`ADEQUAÇÃO CAFÉ DELTA PORTUGAL MU 220G`[DATAFUSION$`CICLO CAFÉ DELTA PORTUGAL MU 220G`=="NÃO" & DATAFUSION$`STOCK CAFÉ DELTA PORTUGAL MU 220G`+DATAFUSION$`Transito CAFÉ DELTA PORTUGAL MU 220G`+DATAFUSION$`Esperado CAFÉ DELTA PORTUGAL MU 220G`< DATAFUSION$`Preslinear CAFÉ DELTA PORTUGAL MU 220G`] <- "STOCK INSUF. C FORN. DESADEQUADO"
...
DATAFUSION$`ADEQUAÇÃO CAFÉ SOLÚVEL DELTA FRASCO 200G`[DATAFUSION$`CICLO CAFÉ SOLÚVEL DELTA FRASCO 200G`=="SIM"] <- "STOCK SUF."
DATAFUSION$`ADEQUAÇÃO CAFÉ SOLÚVEL DELTA FRASCO 200G`[DATAFUSION$`CICLO CAFÉ SOLÚVEL DELTA FRASCO 200G`=="NÃO" & DATAFUSION$`STOCK CAFÉ SOLÚVEL DELTA FRASCO 200G`+DATAFUSION$`Transito CAFÉ SOLÚVEL DELTA FRASCO 200G`+DATAFUSION$`Esperado CAFÉ SOLÚVEL DELTA FRASCO 200G`>= DATAFUSION$`Preslinear CAFÉ SOLÚVEL DELTA FRASCO 200G`] <- "STOCK INSUF. C FORN. ADEQUADO"
DATAFUSION$`ADEQUAÇÃO CAFÉ SOLÚVEL DELTA FRASCO 200G`[DATAFUSION$`CICLO CAFÉ SOLÚVEL DELTA FRASCO 200G`=="NÃO" & DATAFUSION$`STOCK CAFÉ SOLÚVEL DELTA FRASCO 200G`+DATAFUSION$`Transito CAFÉ SOLÚVEL DELTA FRASCO 200G`+DATAFUSION$`Esperado CAFÉ SOLÚVEL DELTA FRASCO 200G`< DATAFUSION$`Preslinear CAFÉ SOLÚVEL DELTA FRASCO 200G`] <- "STOCK INSUF. C FORN. DESADEQUADO"
