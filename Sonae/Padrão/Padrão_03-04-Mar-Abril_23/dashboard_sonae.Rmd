...
```{r}
datatable(DataFusionComMed4[, c(1:3,43,37,5:11,16,20,24,28,32,38:42)], extensions = c('Buttons', 'SearchBuilder'), options = list(
  dom = 'Bfrtip',
  buttons = list(
    'copy', 
    list(
...
```{r}
datatable(BASE_TOTAL, extensions = c('Buttons', 'SearchBuilder'), options = list(
  dom = 'Bfrtip',
...
rmarkdown::render("C:\\Users\\joao_\\Downloads\\dashboard_sonae.Rmd")
