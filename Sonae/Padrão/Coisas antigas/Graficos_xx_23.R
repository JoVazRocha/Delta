...
#Dados todos
Dados <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_xx_2023\\Wide_DataFusion.xlsx")
...
df_Classic <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_xx_2023\G_Classic.xlsx")
...
df_NumProdutos <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_xx_2023\\G_NumProdutos.xlsx")

df_Rotura <- read_excel("D:\\B&N Dados\\Delta\\Padrão\\Padrão_xx_2023\\G_Rotura.xlsx")
